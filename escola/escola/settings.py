# Django settings for escola_novo project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbEscola',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '6j6(fq#1@w21+3-=_u&i9j8u1ud4mz0zayfl&7h^4iw71u(4(%'
